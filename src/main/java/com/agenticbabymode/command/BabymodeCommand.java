...
public final class BabymodeCommand {
	...
	private static int help(CommandContext<ServerCommandSource> ctx) {
		...
		sb.append(String.format("Player: move %.2fx | mine %.1fx | underwater air %.1fx | natural regen %s | PvP %s\n",
				c.player.movementSpeedMultiplier, c.player.miningSpeedMultiplier,
				c.environment.drowningTimeMultiplier, c.player.naturalRegeneration ? "on" : "off",
				c.player.pvp ? "on" : "off"));
